...
for (let i: number = 0; i < numsArr.length - 1; i++){
    for (let j: number = i + 1; j < numsArr.length; j++){
        if(numsArr[i] + numsArr[j] === 2020){
